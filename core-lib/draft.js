...
let sizeProjection = draftFabrikk.constructSizeProjectionBelongings(knot1)
knot1.useSizeProjection(sizeProjection)
...
let knot2 = draftFabrikk.constructKnotFrom(knot1, /* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ (1 * 0.5 * 0.5) * 5, 1, 4 * 1 * 2 * 1.4)
pencil.useKnot(knot2)

// keep
pencil.useSpawn(spawnedPointerBelongingsAnother)
pencil.useSizeProjection(sizeProjection)
...
let knot3 = draftFabrikk.constructKnotFrom(knot1, /* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ (1 * 3.5 * 2) * 5 + 3.2, 1, 1 * 0.5)
...
let knot4 = draftFabrikk.constructKnotFrom(knot1, /* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ (1 * 3.5 * 2) * 5 + 3.2, 1, 1 * 0.5)
...
let knot5 = draftFabrikk.constructKnot(knot1, /* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 + 0.5, 1, 1)
...
for(let i = 1; i <= Array.from(Array(3)).length; i++) {
    ...
    let knotVertical = draftFabrikk.constructKnotFrom(knot1, /* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ 1 + 0.5, 1, 1 * 0.5 * 0.5)
...
let knotClosing = draftFabrikk.constructKnotFrom(knot1, /* keep */ /* let me use bounced memory */ /* y, x, z */ Math.random() * 0.5, Math.random() * 0.5, Math.random() * 0.2, radius, 0.9, 0.4, 1, /* keep */ (1 * 4 * 2) * 5, 1 * 0.5, 4 * 1 * 2 * 1.4)
